...
const Dashboard = () => {
    ...
    const StatCard = ({ icon: Icon, label, value, color, delay }) => (
        ...
        <motion.div
            ...
            className={`glass-panel card-bg p-6 h-full flex flex-col justify-between relative overflow-hidden group border-t-4 ${color.border}`}
        >
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-800 pb-20 transition-colors duration-300">
                ...
                <div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                        <div>
                            ...
                            >
                                <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-100 dark:to-gray-400 mb-2 drop-shadow-sm">
                                    Dashboard
                                </h1>
                                <p className="text-xl text-gray-500 dark:text-gray-400 flex items-center gap-2 font-medium">
                                    Welcome back, <span className="text-primary-dark dark:text-primary">{user?.username}</span> 👋
                                </p>
                            </motion.div>
                        </div>
                    ...
                    {/* Mood Chart */}
                        <div className="mb-16">
                            <h2 className="text-2xl font-bold mb-6 pl-2 border-l-4 border-primary dark:text-white">Your Mood Journey</h2>
                            <div className="glass-panel card-bg p-4">
                        ...
                        <Link to="/add-activity" className="block group">
                            ...
                            >
                                <div className="glass-panel card-bg h-64 flex flex-col items-center justify-center p-8 border-2 border-dashed border-primary/30 group-hover:border-primary transition-all cursor-pointer relative overflow-hidden bg-gradient-to-br from-white/10 to-primary/5">
                                    ...
                                    <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 z-10">Log New Activity</h3>
                                    <p className="text-gray-500 dark:text-gray-400 mt-2 z-10 font-medium">Record meditation, yoga, or breathing</p>
                                </div>
                            </Tilt>
                        </Link>
                    ...
                    >
                        ...
                        <div className="glass-panel card-bg p-10 rounded-2xl relative border-l-8 border-primary shadow-2xl">
                            <Quote className="absolute top-6 left-6 text-primary/20 transform -scale-x-100" size={80} />
                            <blockquote className="text-center relative z-10">
                                <p className="text-2xl italic text-gray-700 dark:text-gray-100 font-serif leading-relaxed">
                                    "The present moment is filled with joy and happiness. If you are attentive, you will see it."
                                </p>
                                <footer className="mt-6 text-gray-500 dark:text-gray-400 font-bold uppercase tracking-widest text-sm">
                                    — Thich Nhat Hanh
                                </footer>
                            </blockquote>
                        </div>
